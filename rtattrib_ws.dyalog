...
Col_Aquamarine_02←0.6627 0.702 0.7255
...
Col_Aquamarine_06←0.7255 0.851 0.9176

Col_Azurite_01←0.2863 0.3569 0.7216

Col_Azurite_02←0.5333 0.6549 0.9059

Col_Azurite_03←0.302 0.3529 0.6314
...
Col_Blue_03←0.35 0.4 0.75

Col_Blue_04←0.1 0.1 0.5

Col_Citrine_01←0.302 0.2314 0.1529

Col_Citrine_02←0.4667 0.3804 0.298

Col_Citrine_03←0.502 0.4118 0.3529

Col_Dark_Green←0.1 0.7 0.8

Col_Emerald_01←0.0471 0.4 0.2549
...
Col_Green_01←0.1 0.85 0.2

Col_Green_02←0.35 0.85 0.1

Col_Green_03←0.2 0.75 0.25

Col_Green_04←0.1 0.5 0.1

Col_Gypsum_01←0.902 0.8824 0.7882

Col_Gypsum_02←0.8039 0.8667 0.8157

Col_Gypsum_03←0.7098 0.6863 0.6

Col_Gypsum_04←0.8275 0.8078 0.5765

Col_Gypsum_05←0.8196 0.7373 0.5294

Col_Gypsum_06←0.5961 0.4941 0.302

Col_Orange←1 0.5 0

Col_Red_01←0.85 0.1 0.2

Col_Red_02←0.85 0.35 0.1

Col_Red_03←0.75 0.2 0.25

Col_Red_04←0.5 0.1 0.1

Col_Ruby←0.9 0.1 0.2

Col_Ruby_01←0.498 0.0824 0.2275

Col_Ruby_02←0.6235 0.149 0.3137
...
Col_Sapphire_01←0.2118 0.302 0.498

Col_Sapphire_02←0.0588 0.2 0.5569

Col_Sapphire_03←0.0392 0.2353 0.5686

Col_Topaz_01←0.7333 0.7451 0.698

Col_Topaz_02←0.5922 0.6196 0.5922

Col_Topaz_03←0.5922 0.6157 0.651

Col_Tourmaline_01←0.3725 0.4235 0.2941

Col_Tourmaline_02←0.2745 0.349 0.2235

Col_Tourmaline_03←0.2627 0.2549 0.1451

Col_Tourmaline_04←0.1333 0.4706 0.3412

Col_Tourmaline_05←0.0627 0.298 0.2118
...
Col_Yellow_01←0.85 0.85 0.2

Col_Yellow_02←0.75 0.78 0.1

Col_Yellow_03←0.78 0.75 0.1

Col_Yellow_04←0.5 0.5 0.1
...
F_Glass10←(3⍴1) 0 0.1 0.6 200 1 1.5 1

F_Glass5←(3⍴1) 0 0 0.7 200 1 1.5 1

F_Glass6←(3⍴1) 0 0.1 0.6 300 1 1.5 1

F_Glass7←(3⍴1) 0 0.15 0.9 200 1 1.5 1

F_Glass8←(3⍴1) 0 0.15 0.6 250 1 1.5 1

F_Glass9←(3⍴1) 0 0 0.8 200 1 1.5 1
...
Gray15←3⍴0.15000000000000002

Gray20←3⍴0.2

Gray25←3⍴0.25

Gray30←3⍴0.30000000000000004
...
LightGray←3⍴0.658824

LightGrey←3⍴0.658824
